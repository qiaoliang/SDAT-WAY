...
program
    .name("sdat-build")
    .description("SDAT-Method build tool for creating web bundles")
    .version("4.0.0");
...
program
    .command("upgrade")
    .description("Upgrade a SDAT-Method V1 project to V2")
    .option(
        "-p, --project <path>",
        "Path to V1 project (defaults to current directory)"
    )
