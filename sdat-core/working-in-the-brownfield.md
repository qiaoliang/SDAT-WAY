...
>
> Gemini Web's 1M+when it's working can analyze your ENTIRE codebase, or critical sections of it,obviously within reason:
>
> - Upload via GitHub URL or use gemini cli in the project folder
> - If working in the web: use `npx sdat-method flatten` to flatten your project into a single file, then upload that file to your web agent.

## What is Brownfield Development?

Brownfield development refers to adding features, fixing bugs, or modernizing existing software projects.new projects, brownfield work requires understanding existing code, respecting constraints, and ensuring new changes integrate seamlessly without breaking existing functionality.
...
If you have just completed an MVP with SDAT, and you want to continue with post-MVP, its easier to just talk to the PM and ask it to work with you to create a new epic to add into the PRD, shard out the epic, update any architecture documents with the architect, and just go from there.

## The Complete Brownfield Workflow

1. **<ins>User Guide - Installation</ins>(user-guide.md#installation) steps to setup your agent in the web.**
2. **Generate a 'flattened' single file of your entire codebase** run: `npx sdat-method flatten`

### Choose Your Approach

#### Approach A:Recommended if adding very large and complex new features, single or multiple epics or massive changes
...
#### Approach B:Good for Smaller Projects
...
**with your flattened-codebase.xml uploaded:**
...
##### Option A:Recommended for Major Changes
